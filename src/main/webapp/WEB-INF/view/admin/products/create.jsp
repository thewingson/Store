            ...
            <form action="/products" method="post">
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="nuber" class="form-control" id="price" name="price">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="quantity">Quantity</label>
                        <input type="nuber" class="form-control" id="quantity" name="quantity">
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-3 mb-3">
                        <label for="vendor">Vendor</label>
                        <select class="custom-select" id="vendor" name="vendorId">
